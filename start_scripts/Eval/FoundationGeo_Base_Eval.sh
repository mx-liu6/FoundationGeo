...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${FOUNDATIONGEO_ROOT}/checkpoints/FoundationGeo_BaseModel.pt}"
OUTPUT_DIR="${FOUNDATIONGEO_ROOT}/eval_output/BaseModel"
OUTPUT_PATH="${OUTPUT_PATH:-${OUTPUT_DIR}/FoundationGeo_BaseModel_res9_fp32.json}"
