...
def main(
    ...
    from foundationgeo.utils.vis import colorize_depth
    from foundationgeo.utils.panorama import spherical_uv_to_directions, get_panorama_cameras, split_panorama_image, merge_panorama_depth
