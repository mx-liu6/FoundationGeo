...
def main(ctx: click.Context, baseline_code_path: str, input_path: str, output_path: str, image_size: int, skip: bool, save_maps_, save_ply_: bool, save_glb_: bool, threshold: float):
    ...
    from foundationgeo.utils.io import save_ply, save_glb
    from foundationgeo.utils.geometry_numpy import intrinsics_to_fov_numpy
    from foundationgeo.utils.vis import colorize_depth, colorize_depth_affine, colorize_disparity
